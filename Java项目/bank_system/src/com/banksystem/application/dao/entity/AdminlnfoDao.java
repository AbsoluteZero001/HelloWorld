...
public class AdminlnfoDao {
    ...
    public AdminlnfoDao(Long id, String password, String nickname, String name, String mobile, String state, String deleted, Long createBy, Long updateBy, Integer createTime, Integer updateTime) {
        this.id = id;
